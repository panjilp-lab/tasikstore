...
class Administrator extends CI_Controller {
    ...
    function penjualan_reseller(){
         $data['record'] = $this->model_reseller->penjualan_list_reseller();
        $this->template->load('administrator/template','administrator/additional/mod_penjualan_reseller/view_penjualan',$data);
    }
    ...
    function pembayaran_reseller(){
      ...
      function pembayaran_konsumen(){
        cek_session_akses('konsumen',$this->session->id_session);
        $data['record'] = $this->db->query("SELECT a.*, b.*, c.kode_transaksi, c.proses FROM `rb_konfirmasi_pembayaran_konsumen` a JOIN rb_rekening b ON a.id_rekening=b.id_rekening JOIN rb_penjualan c ON a.id_penjualan=c.id_penjualan ORDER BY a.id_konfirmasi_pembayaran DESC");
        $this->template->load('administrator/template','administrator/additional/mod_konsumen/view_konsumen_pembayaran',$data);
    }
    ...
    function download_bukti(){
     ...
     function download_bukti_konsumen(){
