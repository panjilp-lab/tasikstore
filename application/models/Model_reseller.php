...
class Model_reseller extends CI_model{
    ...
    function penjualan_list_reseller(){
        return $this->db->query("SELECT * FROM `rb_penjualan` a JOIN rb_konsumen b ON a.id_pembeli=b.id_konsumen JOIN rb_reseller c ON a.id_penjual=c.id_reseller ORDER BY a.id_penjualan DESC;");
    }
