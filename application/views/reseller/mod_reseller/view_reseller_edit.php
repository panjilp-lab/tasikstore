<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('reseller/edit_reseller',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Provinsi</th>               <td><select style='margin-left:5px' class='form-control' name='prov' id='state' required>
                    ...
                    <tr><th scope='row'>Kota</th>               <td>
 <select style='margin-left:5px' class='form-control' name='kota' id='city' required>
                                                <option value=''>- Pilih -</option>
                                        </select>
