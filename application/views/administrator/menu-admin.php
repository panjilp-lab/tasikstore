                ...
                <ul class="treeview-menu">
                  <?php 
                    ...
                    if($cek==1 OR $this->session->level=='admin'){
                      ...
                      $cek=$this->model_app->umenu_akses("penjualan_admin",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/penjualan_admin'><i class='fa fa-circle-o'></i> Penjualan Admin</a></li>";
                    }
  $cek=$this->model_app->umenu_akses("penjualan_pelapak",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/penjualan_pelapak'><i class='fa fa-circle-o'></i> Penjualan Pelapak</a></li>";
                    }
