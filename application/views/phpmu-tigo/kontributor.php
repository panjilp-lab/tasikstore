		...
		<div class="content-block main left">
			<div class="block">
				<div class="block-title" style="background: #bf4b37;">
					<a href="<?php echo base_url(); ?>" class="right">Menu Home</a>
					<h2>Temukan Karir Anda</h2>
				</div>
				<div class="block-content">
					<div class="shortcode-content">
							<div class="column12">
								<div  id="writecomment">
								<p><label for="c_name"><b style='color:red'>CATATAN</b></label><i>DAFTARKAN AKUN ANDA UNTUK MENDAPATKAN INFORMASI LOWONGAN PEKERJAAN TERBARU</i></p><br>
								<?php echo $this->session->flashdata('message'); ?>
								<h2>Job List</h2><br>
								<a href="https://www.jobstreet.co.id/en/job/graphic-designer-3071809?fr=23&searchRequestToken=782a03a0-29d5-486c-ce7a-f1e9a50f77c4&sectionRank=1">Desain Grafis,</a>
								<a href="https://www.jobstreet.co.id/en/job/admin-online-shop-3067869?fr=23&searchRequestToken=782a03a0-29d5-486c-ce7a-f1e9a50f77c4&sectionRank=6">Administrator</a>
