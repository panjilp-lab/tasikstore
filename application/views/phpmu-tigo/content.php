...
echo "<div class='paragraph-row '>
	...
	<div class='column4 hidden-xs' style='margin-left: 1%'>
		...
		<div class='paragraph-row'>
			<div class='column6' style='margin-top:10px'>
				<a target='_BLANK' href='$ik3[url]'><img src='".base_url()."asset/foto_iklanatas/$ik3[gambar]' style='width:100%; height: 177px;'></a>
			</div>
			<div class='column6 ' style='margin-top:10px'>
				<a target='_BLANK' href='$ik4[url]'><img src='".base_url()."asset/foto_iklanatas/$ik4[gambar]' style='width:100%; height: 177px;'></a>
			</div>
		</div>
	</div>
	<div class='column2 hidden-xs' style='margin-left: 1%'>
		<a target='_BLANK' href='$ik5[url]'><img src='".base_url()."asset/foto_iklanatas/$ik5[gambar]' style='width:100%; min-height: 377px;'></a>
	</div>
</div>
<br>";
