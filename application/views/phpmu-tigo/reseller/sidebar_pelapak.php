...
//<tr bgcolor='#e3e3e3'><td rowspan='4' style='width:70px'><center><img style='border:1px solid #cecece; height:60px; width:60px' src='".base_url()."asset/foto_user/$foto_user' class='img-circle img-thumbnail'></center></td></tr>
...
//<a class='btn btn-xs btn-block btn-info' href='".base_url()."produk/detail_reseller/$rows[id_reseller]'>Lihat Profile</a>
        ...
        echo "
<tr bgcolor='#e3e3e3'><td rowspan='4' style='width:70px'><center><img style='border:1px solid #cecece; height:60px; width:60px' src='".base_url()."asset/foto_user/$foto_user' class='img-circle img-thumbnail'></center></td></tr>
    <tr><td colspan='2'><br/><b style='font-size:16px'>$rows[nama_reseller]</b></td></tr>
      </tbody>
      </table>
</div>
...
<br><img style='width:100%' src='".base_url()."asset/foto_pasangiklan/ekpedisi.jpg'>";
?>