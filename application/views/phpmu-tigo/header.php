...
echo "<div class='wrapper'>			
	...
	<div class='header-addons'>
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
            echo "Selamat Datang! <a style='color:#000' href='".base_url()."members/profile'>$ksm[nama_lengkap]</a> &raquo; 
			...
			echo "<a href='".base_url()."members/keranjang'><b> Keranjang Belanja <span class='badge'>".rupiah($isi_keranjang['jumlah'])."</span></b></a> &nbsp; ";
			 ...
			 echo "<a  class='btn btn-xs btn-danger' style='padding:1px 12px' href='".base_url()."produk/keranjang'> Keranjang <span class='badge'>".rupiah($isi_keranjang['jumlah'])."</span></a> ";
