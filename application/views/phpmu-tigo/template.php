			...
			<div class="content">
				<div class="wrapper">	
					<div class="breaking-news">
						<span class="the-title">New Product !!</span>
						<ul>
							<?php
							  $terkini = $this->model_utama->view_where_ordering_limit('rb_produk',array('id_produk_perusahaan' => '0'),'id_produk','DESC',0,10);
							  foreach ($terkini->result_array() as $row) {
								echo "<li><a href='".base_url()."/produk/detail/$row[produk_seo]'>$row[nama_produk]</a></li>";
							  }
							?>
						</ul>
					</div>
