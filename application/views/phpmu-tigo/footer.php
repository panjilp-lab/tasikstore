...
echo "<div class='wrapper'>
	...
	echo "</ul>
	<p>&copy; ".date('Y')." Copyright <b>Marketplace</b> News. All Rights reserved.<br/>Develop by. <b style='color:orange'></b> - Redesign by. <b style='color:orange'>Nama Anda Disini</b></p>
</div>";