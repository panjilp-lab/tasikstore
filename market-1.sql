...
--
-- Host: localhost
-- Generation Time: Sep 30, 2019 at 06:10 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=686 ;
...
(11, 'Total Biaya Pembuatan Aplikasi Simpeg', 'Contoh_File_Download_1.txt', '2014-09-23', 12),
...
(1, 'Marketplace', 'iasrori@gmail.com', 'http://localhost/market', 'm/', '3511887071', '081267771344', 'Menyajikan berita terbaru, tercepat, dan terpercaya seputar tunggul hitam.', 'Selamat datang di CMS Swarakalibata, adalah penyempurnaan dan perbaikan dari swarakalibata sebelumnya.', 'favicon.ico', 'https://www.google.com/maps/place/HKSP+Andalusia+Garden/@-7.3465311,108.1853993,17z/data=!3m1!4b1!4m5!3m4!1s0x2e6f56e2fe4968d1:0xd0a5c352fb9303ff!8m2!3d-7.3465311!4d108.187588');
...
(40, 'Iklan atas 1', 'admin', 'https://members.phpmu.com/', '1.jpg', '2019-03-26'),
(41, 'Iklan atas 2', 'admin', 'https://members.phpmu.com/', '2.jpg', '2019-03-26'),
(42, 'Iklan atas 3', 'admin', 'https://members.phpmu.com/', '3.jpg', '2019-03-26'),
(43, 'Iklan atas 4', 'admin', 'https://members.phpmu.com/', '4.jpg', '2019-03-26'),
(44, 'Iklan atas 5', 'admin', 'https://members.phpmu.com/', '5.jpg', '2019-03-26');
...
(117, 8, 'Download', 'download', 'Ya', 'Bottom', 13),
(115, 0, 'Alamat Kami', 'halaman/detail/alamat-perusahaan', 'Ya', 'Top', 2),
(113, 0, 'Tentang Kami', 'halaman/detail/tentang-kami-tunggul-news', 'Ya', 'Top', 1),
(112, 22, 'Dalam Negeri', '#', 'Ya', 'Bottom', 20),
(151, 0, 'Semua Produk', 'produk', 'Ya', 'Bottom', 9),
(150, 0, 'Menu Order', '#', 'Ya', 'Bottom', 5),
(19, 8, 'Berita Foto', 'albums', 'Ya', 'Bottom', 17),
(18, 8, 'Video', 'playlist', 'Ya', 'Bottom', 16),
(8, 0, 'Tentang HKSP', '#', 'Ya', 'Bottom', 12),
(116, 0, 'Hubungi Kami', 'hubungi', 'Ya', 'Top', 3),
(118, 8, 'Agenda', 'agenda', 'Ya', 'Bottom', 14),
(119, 0, 'Index Berita', 'berita/indeks_berita', 'Ya', 'Top', 4),
(121, 8, 'Konsultasi', 'konsultasi', 'Ya', 'Bottom', 15),
(124, 0, 'Karir', 'kontributor', 'Ya', 'Bottom', 10),
(126, 22, 'Luar Negeri', '#', 'Ya', 'Bottom', 21),
(147, 0, 'Testimoni', 'testimoni', 'Ya', 'Bottom', 11),
(148, 150, 'Konfirmasi Orders', 'konfirmasi', 'Ya', 'Bottom', 7),
(149, 150, 'Tracking Orders', 'konfirmasi/tracking', 'Ya', 'Bottom', 6),
(152, 0, 'Semua UKM', 'produk/reseller', 'Ya', 'Bottom', 18),
(155, 150, 'Orders Report', 'members/orders_report', 'Ya', 'Bottom', 8);
...
(1, '<strong>Haloo!</strong><p>Silahkan Tulis Pesan pada kolom yang tersedia</p>');
...
CREATE TABLE IF NOT EXISTS `rb_bonus` (
...
CREATE TABLE IF NOT EXISTS `rb_kategori_produk_sub` (
...
CREATE TABLE IF NOT EXISTS `rb_konfirmasi_pembayaran` (
...
CREATE TABLE IF NOT EXISTS `rb_konfirmasi_pembayaran_konsumen` (
`id_konfirmasi_pembayaran` int(11) NOT NULL,
  `id_penjualan` int(11) NOT NULL,
  `total_transfer` varchar(20) NOT NULL,
  `id_rekening` int(11) NOT NULL,
...
(27, 'ihsans', 'dfd92241e36ad64cd8718d2abe56be4b0f0c9a110775dedeeb68e0838a87084a55000b811edfadc9cd81d97746bea57662ef34332db292e8db0010d34a3bc344', 'ihsan asrori', 'iasrori@gmail.com', 'Laki-laki', '0000-00-00', '', 'desa sidohasri rt 1', 'kenduruan', 489, '082297707550', '', '2019-05-21'),
(28, 'panji', '74e20fac0c973ab69290f811e6abaf9eefd8f9e48b2171610569f9f28ec68943450a9537981ccd7b8171a5b03af63cc8152f6e118df942ab4f2b7caa85896c81', 'panjilenggari', 'pnj@gmail.com', 'Laki-laki', '0000-00-00', '', 'jl re martadinata', 'indihiang', 468, '082119816893', '', '2019-09-27');
...
CREATE TABLE IF NOT EXISTS `rb_pembayaran_bonus` (
...
CREATE TABLE IF NOT EXISTS `rb_pencairan_bonus` (
...
CREATE TABLE IF NOT EXISTS `rb_pencairan_reward` (
...
(105, 'TRX-20190521215253', 9, 1, 'reseller', 'admin', '', 'Stok Otomatis (Pribadi)', 0, '2019-05-21 21:52:53', '1'),
(106, 'TRX-20190521215429', 27, 1, 'konsumen', 'reseller', 'jne', 'OKE', 31000, '2019-05-21 21:56:15', '0'),
(107, 'TRX-20190521215909', 27, 9, 'konsumen', 'reseller', 'jne', 'CTC', 7000, '2019-05-21 21:59:09', '1'),
(108, 'TRX-20190521223503', 27, 2, 'konsumen', 'reseller', 'jne', 'OKE', 35000, '2019-05-21 22:35:03', '0'),
(109, 'TRX-20190927134741', 28, 2, 'konsumen', 'reseller', '', '', 0, '2019-09-27 13:48:44', '0'),
(110, 'TRX-20190927135116', 10, 1, 'reseller', 'admin', '', 'Stok Otomatis (Pribadi)', 0, '2019-09-27 13:51:16', '1');
...
(172, 105, 27, 10, 0, 0, '1'),
(173, 106, 12, 1, 0, 66000, 'unit'),
(174, 107, 27, 1, 0, 120000, '1'),
(175, 108, 17, 1, 0, 65000, 'pcs'),
(176, 109, 4, 1, 0, 129900, 'unit'),
(177, 110, 28, 1, 0, 0, 'kg');
...
(54, 'TRX-20190927155122', 28, 1, 10, 3000, 'kg', '2019-09-27 15:51:22'),
(55, 'TRX-20190927161500', 28, 1, 10, 3000, 'unit', '2019-09-27 16:15:00');
...
(27, 0, 6, 0, 9, 'celana Panjang', 'celana-panjang', '1', 100000, 0, 120000, '200', 'elektronik2.jpg', '<p>jual murah<br></p>', 'admin', '2019-05-21 21:52:53'),
(28, 0, 1, 3, 10, 'iphone', 'iphone', 'unit', 2000, 0, 3000, '3', '', '<p>barang bagus</p>', 'hksp', '2019-09-27 13:51:16');
...
CREATE TABLE IF NOT EXISTS `rb_produk_diskon` (
...
CREATE TABLE IF NOT EXISTS `rb_rekening_reseller` (
...
CREATE TABLE IF NOT EXISTS `rb_reseller` (
`id_reseller` int(11) NOT NULL,
  `username` varchar(50) NOT NULL,
...
(9, 'ihsans', 'dfd92241e36ad64cd8718d2abe56be4b0f0c9a110775dedeeb68e0838a87084a55000b811edfadc9cd81d97746bea57662ef34332db292e8db0010d34a3bc344', 'EL-IHSAN', 'Laki-laki', 489, 'desa sidohasri kec kenduruan', '082297707550', 'iasrori@gmail.com', 67866, '', '20181130060225_IMG_1885(1).jpg', 'admin', '2019-05-21 21:49:27'),
(10, 'hksp', '2cc8e8ac6ea6c333abb10ac8986a3b15b23e457fdde937cd8a8baf49e6c0213c96e5fef2f1c0a0fe6ffea39129e12718f1ce043b2ac826f2759d47f3eca59654', 'tokotasik', 'Laki-laki', 469, 'mangkubumi', '083222333444', 'hksp@gmail.com', 46386, '', '', 'seller', '2019-09-27 13:49:54');
...
CREATE TABLE IF NOT EXISTS `rb_reward` (
...
('::1', '2019-05-21', 85, '1558453029'),
('::1', '2019-06-08', 4, '1559962235'),
('127.0.0.1', '2019-06-08', 16, '1559986922'),
('::1', '2019-06-17', 1, '1560769927'),
('::1', '2019-09-25', 59, '1569394626'),
('::1', '2019-09-27', 92, '1569576344'),
('::1', '2019-09-30', 3, '1569859784');
...
('admin', 'bff0cc42103de1b4721370e84dc24f635a7afeca41198c9b3e03946a1b6b7191d14356408a5e57ce6daf77e6e800c66fac7ab0482d57d48d23e6808e4b562daa', 'panjul', 'pnj@gmail.com', '082119816893', 'aku.jpg', 'admin', 'N', 'q173s8hs1jl04st35169ccl8o7'),
...
--
ALTER TABLE `rb_penjualan`
MODIFY `id_penjualan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=111;
--
-- AUTO_INCREMENT for table `rb_penjualan_detail`
--
ALTER TABLE `rb_penjualan_detail`
MODIFY `id_penjualan_detail` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=178;
--
-- AUTO_INCREMENT for table `rb_penjualan_temp`
--
ALTER TABLE `rb_penjualan_temp`
MODIFY `id_penjualan_detail` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `rb_produk_diskon`
MODIFY `id_produk_diskon` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
